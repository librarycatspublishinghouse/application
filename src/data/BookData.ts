...
export const Books: IBook[] = [
    {
        ...
        thumbnailLink: getImagePath("/pictures/books/publications/thumbnails/contemporaruSubjectsCover.webp"),
        downloadLink: getImagePath("/pictures/books/publications/PDF/ContemporarySubjects.pdf"),
        format: "PDF",
        downloads: 398,
...

    {
        ...
        thumbnailLink: getImagePath("/pictures/books/publications/thumbnails/blueMoon.webp"),
        downloadLink: getImagePath("/pictures/books/publications/PDF/BlueMoon.pdf"),
        format: "PDF",
        downloads: 95,
        isbn: "",
        language: "English",
...

    {
        ...
        thumbnailLink: getImagePath("/pictures/books/publications/thumbnails/ebbsAndFlows.webp"),
        downloadLink: getImagePath("/pictures/books/publications/PDF/ebbsAndFlows.pdf"),
        format: "PDF",
        downloads: 53,
        isbn: "",
        language: "English",
