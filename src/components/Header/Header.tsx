            ...
            <div className={style.grid_container}>
                ...
                <div className={style.bars_container}>
                    <svg className={style.bars_icon} onClick={toggle} >
                            <path fillRule="evenodd" fill="rgb(0, 0, 0)" d="M-0.000,-0.000 L20.000,-0.000 L20.000,2.000 L-0.000,2.000 L-0.000,-0.000 Z"></path>
                            <path fillRule="evenodd" fill="rgb(0, 0, 0)" d="M-0.000,8.000 L17.000,8.000 L17.000,10.000 L-0.000,10.000 L-0.000,8.000 Z"></path>
                            <path fillRule="evenodd" fill="rgb(0, 0, 0)" d="M-0.000,16.000 L20.000,16.000 L20.000,18.000 L-0.000,18.000 L-0.000,16.000 Z"></path>
                    </svg>  
                </div>      
                ...
                <div className={style.header_logo_container}>
                    ...
                    <div className={style.header_logo} >
                        <Link to="/">
                            <img className={style.logo_item} src={`${process.env.PUBLIC_URL}/pictures/site-logo-white-bg.jpeg`} alt="logo"/>
                        </Link>
                    </div>
                </div>
