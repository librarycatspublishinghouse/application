            ...
            <div className={style.terms_container}>
                ...
                <div className={style.container_2}>
                    ...
                    <div className={style.document_container}>
                        ...
                        <a className={style.link} href = {`${process.env.REACT_APP_BACKEND_URL}/files/policies/termsAndConditions.pdf`} target="_blank">
                            
                            <div className={style.document}>

                                <div className={style.document_image}>
                                    <img className={style.document_image_item} src="pictures/terms-and-conditions/icon_paper-search.png" alt="Terms and Conditions" />
                                </div>
                        ...
                        <a className={style.link} href = {`${process.env.REACT_APP_BACKEND_URL}/files/policies/privacyPolicy.pdf`} target="_blank">

                            <div className={style.document}>

                                <div className={style.document_image}>
                                    <img className={style.document_image_item} src="pictures/terms-and-conditions/icon_paper-lock.png" alt="Terms and Conditions" />
                                </div>
